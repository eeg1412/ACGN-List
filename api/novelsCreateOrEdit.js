...
module.exports = async function (req, res, next) {
    ...
    let saveData = null;
    if (type === 'edit') {
        await novelsUtils.updateOne({ _id: _id }, saveParams);
    } else {
        saveData = await novelsUtils.save(saveParams);
    }
    ...
    if (base64) {
        if (saveData) {
            ...
            fs.writeFileSync(`./cover/novel/${saveData._id}.jpg`, base64Data, 'base64');
        } else {
            const base64Data = base64.replace(/^data:image\/jpeg;base64,/, "");
            fs.writeFileSync(`./cover/novel/${_id}.jpg`, base64Data, 'base64');
        }
